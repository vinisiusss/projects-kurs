...
namespace Геофизика_фалй.registerDataSet3TableAdapters {
...
SELECT id, Фио, контактный_номер, Адрес, Возраст FROM operator WHERE (id = @id)";
        ...
        public virtual int Fill(registerDataSet3.operatorDataTable dataTable) {
        ...
        public virtual registerDataSet3.operatorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            registerDataSet3.operatorDataTable dataTable = new registerDataSet3.operatorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(registerDataSet3.operatorDataTable dataTable) {
